...
const iconForHabit = (name: string) => /licuado/i.test(name) ? '/icons/morning-salad.png' : /entren|ejerc|gimnas/i.test(name) ? '/icons/exercise.webp' : /estudi|leer/i.test(name) ? '/icons/study.webp' : /finanz/i.test(name) ? '/icons/finance.webp' : /plane|disciplina/i.test(name) ? '/icons/discipline.webp' : /trabajo|bloque/i.test(name) ? '/icons/work.webp' : /prospect|venta/i.test(name) ? '/icons/client-prospecting.png' : '/icons/habits.webp';
...
export default function Home() {
  ...
  useEffect(() => {
    try {
      ...
      if (localStorage.getItem(MONEY_VERSION) !== '2') {
        setCash(0);
